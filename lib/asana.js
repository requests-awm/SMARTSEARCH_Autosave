...
const TASK_FIELDS =
  'name,completed,permalink_url,created_at,custom_fields.gid,custom_fields.name,custom_fields.type,custom_fields.display_value,custom_fields.date_value,custom_fields.text_value';
...
export function summarizeTask(task, attachments) {
  ...
  return {
    ...
    eligible: !!contactId && requiredFields.every((f) => f.filled) && hasPdf,
  };
}
